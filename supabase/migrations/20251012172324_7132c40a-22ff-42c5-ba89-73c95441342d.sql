-- Update can_user_register_for_course_enhanced to use period-based calculation for limited memberships
  ...
  IF booking_rules IS NOT NULL THEN
    ...
    ELSIF booking_rules->>'type' = 'limited' THEN
      ...
      ELSE
        ...
        -- Example: start_date = 11.10.2025 → October period = 11.10. - 10.11.
    ...
    ELSIF booking_rules->>'type' = 'credits' THEN
      -- Credits type still uses stored remaining_credits
