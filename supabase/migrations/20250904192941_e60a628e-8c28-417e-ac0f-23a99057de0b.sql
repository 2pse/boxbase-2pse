-- Fix existing membership plans with missing period_type using correct enum values
-- Update all monthly_limit plans that have null period_type
UPDATE public.membership_plans 
SET period_type = 'month', updated_at = now()
...
UPDATE public.membership_plans 
SET period_type = 'week', updated_at = now()
