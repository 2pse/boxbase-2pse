-- Update can_user_register_for_course_enhanced to count free_training sessions for LIMITED memberships
...
BEGIN
  ...
  IF booking_rules IS NOT NULL THEN
    ...
    ELSIF booking_rules->>'type' = 'limited' THEN
      ...
      -- Count BOTH course registrations AND open gym sessions (free_training) in period
