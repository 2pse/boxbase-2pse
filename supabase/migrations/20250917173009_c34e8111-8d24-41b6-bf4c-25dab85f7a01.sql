-- Drop and recreate can_user_register_for_course_enhanced with JSON return type for waitlist support
DROP FUNCTION IF EXISTS public.can_user_register_for_course_enhanced(uuid, uuid);
