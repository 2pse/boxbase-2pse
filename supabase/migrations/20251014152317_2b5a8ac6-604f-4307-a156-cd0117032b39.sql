-- Fix: Add central expiration check for ALL membership types in can_user_register_for_course_enhanced
...
BEGIN
  ...
  IF booking_rules IS NOT NULL THEN
    ...
    ELSIF booking_rules->>'type' = 'limited' THEN
      ...
      -- Expiration check already performed centrally above
      ...
      -- Count registrations in TARGET period
      SELECT COUNT(*)
      INTO used_in_period
      FROM public.course_registrations cr
