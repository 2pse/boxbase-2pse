...
export const Dashboard: React.FC<DashboardProps> = ({ user, userRole }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="fixed bottom-0 left-0 right-0 border-t bg-background p-2 md:p-5 z-50 h-[72px] md:h-[86px]">
          ...
          {[
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center gap-1 md:gap-2 h-full py-2 md:py-2 px-3 md:px-4 rounded-md transition-colors ${
                  activeTab === tab.id 
